...
<body>
  <script>
    ...
    if (!parentDoc.getElementById('border-glow-style')) {
      ...
      style.innerHTML = `
        .border-glow-card {
          ...
          --glow-color: hsl(190deg 95% 55% / 100%);
          --glow-color-60: hsl(190deg 95% 55% / 60%);
          --glow-color-50: hsl(190deg 95% 55% / 50%);
          --glow-color-40: hsl(190deg 95% 55% / 40%);
          --glow-color-30: hsl(190deg 95% 55% / 30%);
          --glow-color-20: hsl(190deg 95% 55% / 20%);
          --glow-color-10: hsl(190deg 95% 55% / 10%);

          --gradient-one: radial-gradient(at 80% 55%, #8b5cf6 0px, transparent 50%);
          --gradient-two: radial-gradient(at 69% 34%, #06b6d4 0px, transparent 50%);
          --gradient-three: radial-gradient(at 8% 6%, #a5f3fc 0px, transparent 50%);
          --gradient-four: radial-gradient(at 41% 38%, #c4b5fd 0px, transparent 50%);
          --gradient-five: radial-gradient(at 86% 85%, #06b6d4 0px, transparent 50%);
          --gradient-six: radial-gradient(at 82% 18%, #8b5cf6 0px, transparent 50%);
          --gradient-seven: radial-gradient(at 51% 4%, #0284c7 0px, transparent 50%);
          --gradient-base: linear-gradient(#06b6d4 0 100%);
    ...
    window.addEventListener('unload', () => {
      ...
      const style = parentDoc.getElementById('border-glow-style');
